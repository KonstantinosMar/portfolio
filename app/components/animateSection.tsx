...
const AnimateSection = () => {
    ...
    return (
        <>
            <div id="home" className={`main flex-[1] flex flex-col justify-center items-center h-[calc(100vh_-_90px)] z-[-1] fixed w-[-webkit-fill-available] overflow-hidden bg-[linear-gradient(90deg,#141204_50%,#CBA135_50%)] mr-[25px] sm:mr-[45px] 
